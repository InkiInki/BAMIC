...
class BaMic(MIL):
    ...
    def __init__(self, path, has_ins_label=True, k=10, k_m=0.99, b2b='ave_hausdorff'):
        """
        The constructor.
        """
        super(BaMic, self).__init__(path, has_ins_label)
        self.k = k
        self.k_m = k_m
        self.b2b = b2b
        self.dis = []
    ...
    def __initialize_bamic(self):
        ...
        """
        self.dis = B2B(self.data_name, self.bags, self.dimensions, self.b2b).get_dis()
    ...
    def get_mapping(self):
        ...
        for loop_k in range(self.k):
            ...
            yield temp_dis[temp_tr_idx], self.bags_label[temp_tr_idx], \
                  temp_dis[self.te_idx[loop_k]], self.bags_label[self.te_idx[loop_k]], None
