...
from FunctionTool import print_progress_bar
...
class B2B:
    ...
    def __initialize__b2b(self):
        ...
        """
        self.dis_path = 'D:/Data/TempData/DisOrSimilarity/b2b_' + self.name + '_' + self.dis_type + '_' + self.ins_dis_type
